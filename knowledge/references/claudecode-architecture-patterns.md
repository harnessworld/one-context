...
> Source index: [knowledge/references/claudecode-source-analysis.md](../references/claudecode-source-analysis.md)
> 更新日期：2026-04-02
...
### 5.1 Design Pattern: Ephemeral Subagent

Subagent 是"轻量级"委托执行机制——本质上是一个 ephemeral subagent，没有共享的持久上下文，执行完毕后即销毁。
