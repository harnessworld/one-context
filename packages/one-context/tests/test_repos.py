"""Tests for one_context.repos — YAML parsing, URL inference, alias handling."""
...
from one_context.repos import _normalize_aliases, _repo_name_from_url, load_repos
...
class TestRepoNameFromUrl:
    ...
    def test_empty_path_raises(self):
        with pytest.raises(ManifestError, match="Cannot infer repo name"):
            _repo_name_from_url("https://example.com")
